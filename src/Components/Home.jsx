  ...
  return (
    <div className="root h-screen flex flex-col justify-between items-center relative">
      ...
      <nav className="relative z-10 flex flex-row w-full justify-between items-center p-3 md:p-5">
        ...
        <div>
          <ul className="relative flex flex-row md:gap-4 text-neutral-300 text-lg md:text-xl py-1 md:py-2 px-0.5 rounded-full backdrop-blur-[1px] overflow-hidden">
            {/* Active indicator */}
            <div
            ...
            {navIcons.map((icon, i) => (
              <li key={icon} className="relative z-10 flex-1 flex justify-center">
                <p
                  ...
                  className={`p-1 md:p-2 px-4 md:px-4 rounded-full cursor-pointer transition-all duration-300 ease-in-out transform hover:scale-110 ${getOpacityClass(i)} ${
                    activeIndex === i
                      ? 'scale-105'
                      : 'hover:shadow-sm'
                  }`}
      ...
      {/* Main Content */}
      <div className="relative z-10 flex flex-col md:flex-row justify-between items-center w-full flex-1 px-5 md:px-10">
        <div className="flex flex-col w-full justify-start items-start gap-3 md:gap-5">
