    ...
    <div id="skills" ref={containerRef} className="min-h-screen flex flex-col justify-center items-center py-16 px-4 relative overflow-hidden z-10">
      <div className="max-w-6xl w-full space-y-16 z-10 relative">
        ...
        <div className="text-center skill-section">
          <h1 className="underlines text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#0c8cf5] to-[#8b5cf6] mb-8 tracking-wide">
            FRONTEND
          </h1>
          <ul className="flex flex-wrap justify-center items-center gap-8 md:gap-12">
            <li className="flex flex-col items-center space-y-2 group">
              ...
              />
              <p className="text-lg md:text-xl text-gray-800 dark:text-white font-medium">HTML</p>
            </li>
            <li className="flex flex-col items-center space-y-2 group">
              <Icon
              ...
              />
              <p className="text-lg md:text-xl text-gray-800 dark:text-white font-medium">CSS</p>
            </li>
            <li className="flex flex-col items-center space-y-2 group">
              <Icon
              ...
              />
              <p className="text-lg md:text-xl text-gray-800 dark:text-white font-medium">JS</p>
            </li>
            <li className="flex flex-col items-center space-y-2 group">
              <Icon
              ...
              />
              <p className="text-lg md:text-xl text-gray-800 dark:text-white font-medium">REACT</p>
            </li>
            <li className="flex flex-col items-center space-y-2 group">
              <Icon
              ...
              />
              <p className="text-lg md:text-xl text-gray-800 dark:text-white font-medium">BOOTSTRAP</p>
            </li>
            <li className="flex flex-col items-center space-y-2 group">
              <Icon
              ...
              />
              <p className="text-lg md:text-xl text-gray-800 dark:text-white font-medium">TAILWIND</p>
            </li>
          </ul>
        </div>
        ...
        <div className="text-center skill-section">
          ...
          <ul className="flex flex-wrap justify-center items-center gap-8 md:gap-12">
            <li className="flex flex-col items-center space-y-2 group">
              ...
              />
              <p className="text-lg md:text-xl text-gray-800 dark:text-white font-medium">NODE</p>
            </li>
            <li className="flex flex-col items-center space-y-2 group">
              <Icon
              ...
              />
              <p className="text-lg md:text-xl text-gray-800 dark:text-white font-medium">MONGO</p>
            </li>
            <li className="flex flex-col items-center space-y-2 group">
              <Icon
              ...
              />
              <p className="text-lg md:text-xl text-gray-800 dark:text-white font-medium">EXPRESS</p>
            </li>
            <li className="flex flex-col items-center space-y-2 group">
              <Icon
              ...
              />
              <p className="text-lg md:text-xl text-gray-800 dark:text-white font-medium">ORACLE</p>
            </li>
            <li className="flex flex-col items-center space-y-2 group">
              <Icon
              ...
              />
              <p className="text-lg md:text-xl text-gray-800 dark:text-white font-medium">PRISMA</p>
            </li>
          </ul>
        </div>
        ...
        <div className="text-center skill-section">
          ...
          <ul className="flex flex-wrap justify-center items-center gap-8 md:gap-12">
            <li className="flex flex-col items-center space-y-2 group">
              ...
              />
              <p className="text-lg md:text-xl text-gray-800 dark:text-white font-medium">FIGMA</p>
            </li>
            <li className="flex flex-col items-center space-y-2 group">
              <Icon
              ...
              />
              <p className="text-lg md:text-xl text-gray-800 dark:text-white font-medium">XD</p>
            </li>
            <li className="flex flex-col items-center space-y-2 group">
              <Icon
              ...
              />
              <p className="text-lg md:text-xl text-gray-800 dark:text-white font-medium">ILLUSTRATOR</p>
            </li>
            <li className="flex flex-col items-center space-y-2 group">
              <Icon
              ...
              />
              <p className="text-lg md:text-xl text-gray-800 dark:text-white font-medium">INKSCAPE</p>
            </li>
            <li className="flex flex-col items-center space-y-2 group">
              <Icon
                icon="circum:penpot"
                className="text-6xl md:text-7xl text-blue-600 transition-transform duration-300 group-hover:scale-110"
              />
              <p className="text-lg md:text-xl text-gray-800 dark:text-white font-medium">PENPOT</p>
            </li>
            <li className="flex flex-col items-center space-y-2 group">
              <Icon
                ...
                className="text-6xl md:text-7xl text-cyan-500 transition-transform duration-300 group-hover:scale-110"
              />
              <p className="text-lg md:text-xl text-gray-800 dark:text-white font-medium">CANVA</p>
            </li>
          </ul>
        </div>
      </div>
