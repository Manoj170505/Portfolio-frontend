...
const Education = () => {
    ...
    return (
        <section id="education" className="py-16 md:py-24 relative overflow-hidden z-10">
            <h2 className="text-4xl md:text-5xl font-bold text-center mb-16 relative z-10 text-gray-900 dark:text-white">
                My <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0c8cf5] to-[#8b5cf6]">Education</span>
            </h2>
            <div className="max-w-4xl mx-auto px-4 relative z-10">
                <div className="relative border-l-4 border-gray-300 dark:border-gray-700 ml-4 md:ml-8 space-y-12">
                    {educationData.map((item, index) => (
                        <div key={index} className="relative pl-8 md:pl-12 edcard">
                            {/* Dot */}
                            ...
                            <div className="bg-white/50 dark:bg-white/5 backdrop-blur-sm p-6 rounded-2xl border border-gray-200 dark:border-white/10 shadow-xl hover:transform hover:-translate-y-1 transition-all duration-300">
                                ...
                                <h4 className="text-lg text-gray-700 dark:text-gray-300 font-medium mb-3">{item.institution}</h4>
                                <p className="text-gray-600 dark:text-gray-400 font-medium">{item.score}</p>
                            </div>
                        </div>
                    ))}
                </div>
